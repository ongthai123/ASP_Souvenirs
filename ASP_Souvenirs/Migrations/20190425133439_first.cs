    ...
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sourvenir", x => x.SouvenirID);
                    table.ForeignKey(
                        name: "FK_Sourvenir_Category_CategoryID",
                        column: x => x.CategoryID,
                        principalTable: "Category",
                        principalColumn: "CategoryID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sourvenir_Supplier_SupplierID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourvenirSouvenirID = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.SourvenirSouvenirID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderItem_Sourvenir_SourvenirSouvenirID",
                        column: x => x.SourvenirSouvenirID,
                        principalTable: "Sourvenir",
                        principalColumn: "SouvenirID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItem_SourvenirSouvenirID",
                table: "OrderItem",
                column: "SourvenirSouvenirID");

            migrationBuilder.CreateIndex(
                name: "IX_Sourvenir_CategoryID",
                table: "Sourvenir",
                column: "CategoryID");

            migrationBuilder.CreateIndex(
                name: "IX_Sourvenir_SupplierID",
                table: "Sourvenir",
                column: "SupplierID");
        }
